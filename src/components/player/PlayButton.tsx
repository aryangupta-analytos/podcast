...
export default function PlayButton({ episode }: Props) {
  ...
  return (
    <div class="flex h-16 w-16 items-center justify-center">
      <button
        class="bg-primary text-on-primary flex h-14 w-14 items-center justify-center rounded-full transition-all duration-300 hover:h-16 hover:w-16 hover:bg-linear-to-r hover:from-primary hover:to-accent-4"
        type="button"
        onClick={() => {
          if (episode) {
